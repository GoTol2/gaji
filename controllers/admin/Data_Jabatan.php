...
class Data_Jabatan extends CI_Controller {
	...
	public function _rules() {
		...
		$this->form_validation->set_rules('tj_kinerja','Tunjangan kinerja','required');
		$this->form_validation->set_rules('tj_struktural','Tunjangan struktural','required');
	}
