      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-left my-auto">
            <span>Copyright &copy; Zin11 | SIP-MU</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["HRD", "Manager", "Staff Marketing", "Direktur", "Guru"],
    datasets: [{
      ...
      <?php echo $this->db->query("select jabatan from data_pegawai where jabatan='Guru'")->num_rows(); ?>],
