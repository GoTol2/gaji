               ...
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        ...
                        <p>Welcome to Aplication Payroll Employee <br>SMAI Mishbahul Ulum</p>
                     </div>
                  </div>
         ...
         <div class="Section">
            <div class="text-center">
               ...
               <div class="subHeading">
                  Berikut informasi lebih lengkap tentang website <br>informasi penggajian karyawan SMAI Mishbahul Ulum</div>
            </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel1">aplikasi ini dibuat untuk membantu dalam proses penggajian karyawan</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel4">lupa password, login karyawan</div>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="team-memeber col-md-6 col-lg-4 col-xl-3">
                     <div class="card">
                        ...
                        <div class="TeamInfo text-center">
                           ...
                           <div class="Job">SMAI Mishbahul Ulum</div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-12 text-center my-3">
                  Copyright &copy; Zin11| SIP-MU - All Rights Reserved
               </div>
            </div>
         </div>
      </div>
